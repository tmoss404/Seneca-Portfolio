CREATE OR REPLACE PACKAGE Lab5 IS
    ...
    PROCEDURE show_bizdays (p_date DATE := SYSDATE);
    
    PROCEDURE show_bizdays (p_date DATE, p_days NUMBER);
...
END Lab5;
/
--Using 20-NOV-11, 27-NOV-11 to show example matching output
EXECUTE lab5.show_bizdays('20-NOV-11');
EXECUTE lab5.show_bizdays('27-NOV-11');